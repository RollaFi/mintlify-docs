...
1. **Fund your wallet** — Your wallet is funded automatically from settled transactions, or you can top it up from the dashboard through any payment channel enabled for that currency.
...
| Mobile Money | GHS, XOF | Send to mobile money wallets |
